...
const supportedQuestions = ['control_fullname', 'control_email', 'control_phone', 'control_dropdown'];

export const getOrderedQuestions = createSelector(
    getQuestions,
    data => {
        const filtered = Object.values(data).filter((question: any) => supportedQuestions.indexOf(question.type) > -1);
